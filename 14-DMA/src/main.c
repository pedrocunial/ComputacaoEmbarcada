...
// XDMAC channel HW interface number for SPIO
#define USART_XDMAC_TX_CH_NUM 9
#define USART_XDMAC_RX_CH_NUM 10

// XDMA peripheral interface
#define USART_XDMA_DEST_REG &CONSOLE_UART->US_THR
#define USART_XDMA_ORIG_REG &CONSOLE_UART->US_RHR

// The buffer size for transer
						  ...
						  uint32_t buffer_size)
{
	...
	g_xdmac_rx_cfg.mbr_da  = (uint32_t) origin_address;
